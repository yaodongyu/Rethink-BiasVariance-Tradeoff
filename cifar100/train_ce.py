...
parser.add_argument('--arch', type=str, default='resnet34',
                    help='choose the archtecure from [resnet18/resnet34/resnet50]')
...
# setup log file
##################################################
outdir = '{}_{}_trial{}_mse{}'.format(args.dataset, args.arch, args.trial, args.outdir)
...
def train(net, trainloader):
    ...
    for batch_idx, (inputs, targets) in enumerate(trainloader):
        ...
        optimizer.zero_grad()
        outputs = net(inputs)
        loss = nn.CrossEntropyLoss(size_average=True)(outputs, targets)
        loss.backward()
        optimizer.step()
