...
class ResNet(nn.Module):
    ...
    def __init__(self, block, num_block, k=10, num_classes=100):
        ...
        self.conv1 = nn.Sequential(
            nn.Conv2d(3, 1 * k, kernel_size=3, padding=1, bias=False),
            nn.BatchNorm2d(1 * k),
            nn.ReLU(inplace=True))
...
def resnet18(width=10):
    """ return a ResNet 18 object
    """
    return ResNet(BasicBlock, [2, 2, 2, 2], width)


def resnet34(width=10):
    """ return a ResNet 34 object
    """
    return ResNet(BasicBlock, [3, 4, 6, 3], width)


def resnet50(width=10):
    """ return a ResNet 50 object
    """
    return ResNet(BottleNeck, [3, 4, 6, 3], width)


def resnet101(width=10):
    """ return a ResNet 101 object
    """
    return ResNet(BottleNeck, [3, 4, 23, 3], width)


def resnet152(width=10):
    """ return a ResNet 152 object
    """
    return ResNet(BottleNeck, [3, 8, 36, 3], width)
