...
def ResNet18(width=1):
    return ResNet(BasicBlock, [2, 2, 2, 2], k=width)
...
def ResNet26_bottle(width=1):
    return ResNet(Bottleneck, [2, 2, 2, 2], k=width)


def ResNet38_bottle(width=1):
    return ResNet(Bottleneck, [3, 3, 3, 3], k=width)


def ResNet50_bottle(width=1):
